...
class Interface extends StatefulWidget {
  final User user;
  Interface({@required this.user});

  @override
  _InterfaceState createState() => _InterfaceState(user);
}

class _InterfaceState extends State<Interface> {

  _InterfaceState(this.user);
  User user;
  ...
  TemperatureDoc _temp =
      TemperatureDoc(company: _company, equipment: _equipment);
  ...
  void handleClick(String value) async {
    switch (value) {
      case 'Logout':
        ...
        saveUserToSpSuccess = await prefs.clear();
                  ...
                  children: [
                    notEmptyPorts && _status == "Connected"
                        ? Text(
                            ...
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: _temp.temperature() == 0 ? 29 : 88,
                            ),
                          )
                        : Text(
                            'Por favor conecta el termometro 📲',
                            textAlign: TextAlign.center,
                            style: TextStyle(
